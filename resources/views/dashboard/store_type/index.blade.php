<x-dashboard-layout>
    ...
    <div class="card card-xl-stretch mb-5 mb-xl-8">
        ...
        <div class="card-body py-3">
            <div class="card-body py-3 d-flex justify-content-end">
                <a href="{{ route('type_store.create') }}" class="btn btn-primary">Add Store Type</a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('type_store.edit' , $storeType->id)}}"
                                ...
                                <a href="#" class="btn btn-icon btn-danger btn-sm mx-1"
                                    onclick="showDeleteConfirmation({{ $storeType->id }})">
    ...
    <script>
        function showDeleteConfirmation(cityId) {
            ...
            deleteForm.action = "{{ route('type_store.destroy', '') }}" + '/' + cityId; // Set the correct delete route

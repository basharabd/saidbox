<x-dashboard-layout>
    <x-slot name="title_page">Create Branch</x-slot>
    <x-slot name="title">Create Branch</x-slot>
        ...
        <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
            ...
            <div class="flex-row-fluid py-lg-5 px-lg-15">
                ...
                <div class="card card-custom">
                    <div class="card-body">
                        <!--begin::Form-->
                        <form action="{{ route('branches.store') }}" method="POST" class="form" novalidate="novalidate"
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <select class="form-select form-select-lg form-select-solid" id="city" name="city_id">
                                            <option selected value="">Select City</option> <!-- Default option -->
                                    ...
                                    <div class="fv-row mb-10">
                                        <label class="d-flex align-items-center fs-5 fw-bold mb-2 text-dark" for="branchName">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                title="Specify the branch name"></i>
                                        </label>
                                        <input type="text" class="form-control form-control-lg form-control-solid" id="branchName" name="branch_name" />
                                        @error('branch_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <input type="email" class="form-control form-control-lg form-control-solid" id="email" name="email" />
                                        @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid" id="mobileNumber"
                                            name="mobile_number" />
                                        @error('mobile_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
